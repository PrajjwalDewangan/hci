      ...
      <footer className={props.className}>
        <div className="flex flex-col items-center justify-center w-full">
          <div className="bg-gray_100 flex items-end justify-start p-7 sm:px-5 w-full">
            <div className="flex flex-col gap-4 items-center justify-start mb-[22px] mr-[115px] w-[79%] md:w-full">
              <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[99%] md:w-full">
                <Text
                  className="font-dosis mb-[3px] not-italic text-black_900 text-left underline w-auto"
                  variant="body2"
                >
                  About us
                </Text>
                <Text
                  className="font-dosis md:ml-[0] ml-[370px] md:mt-0 mt-[3px] not-italic text-black_900 text-center underline w-auto"
                  variant="body2"
                >
                  Help
                </Text>
              ...
              <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[99%] md:w-full">
                <Text
                  className="font-dosis text-black_900_99 text-left"
                  variant="body5"
                >
                  <>
                    Our story
                ...
                <div className="flex flex-col gap-[25px] items-center justify-start md:ml-[0] ml-[156px] md:mt-0 mt-[3px] w-auto md:w-full">
                  ...
                  <Text
                    className="font-dosis not-italic text-black_900 text-center underline w-auto"
                    variant="body2"
                  >
                    Gifting
                  </Text>
          ...
          <Text
            className="bg-black_900 font-dosis h-[53px] justify-center max-w-[1439px] md:max-w-full not-italic pb-[9px] pt-[15px] sm:px-5 px-[35px] text-center text-white_A700 w-full"
            variant="body7"
          ></Text>
        </div>
      </footer>
